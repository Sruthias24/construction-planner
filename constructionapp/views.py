    ...
    if 'id' in request.session:
        ...
        if 'user_model' in request.session:
            ...
            if user_model_name == 'architecture':
                ...
                user_model = Contractors
                data=ContractorBooking.objects.filter(Contractor=user_id)
                print(user_id)
                return render(request,"view_requests.html",{'data':data,'user_model':user_model_name})
            ...
            if user_model_name == 'user':
                ...
                if data2:
                    for i in data2:
                        ...
                        print(booked1)
                    print(booked1)
                    return render(request,"user_request.html",{'data':data,'data2':data2,'data3':data3,'booked1':booked1})
                if data3:
                    for i in data3:
                        booked2=i.Contractor
                    return render(request,"user_request.html",{'data':data,'data2':data2,'data3':data3,'booked2':booked2})
